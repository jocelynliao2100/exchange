...
def render_exchange_analysis():
    ...
    # 📍 地名熱點地圖
    st.markdown("### 🗺️ 中國新聞地名熱點圖")

    data = {
        "地点": ["贵州", "成都", "四川", "武汉", "重庆", "广东", "福建", "珠海", "广州", "青岛", "南京", "东莞",
        ...
        "次数": [289, 260, 232, 226, 225, 202, 174, 160, 157, 155, 133, 132,
    ...
    fig.update_layout(
        ...
        geo=dict(
            ...
            center=dict(lon=105, lat=30),
            lataxis=dict(range=[18, 50]),
